...
- **Date**: 2026-04-14 19:43
- **Branch**: `ek/tom-eric-moe-tuning`
- **Commit**: `56b6c84 adding a full audit of the gemma 4 code path`
- **Quantization**: bf16
...
Standard assistant system prompt — verbatim text in [benchmarks README](../README.md#system-prompts).
...
|--------|---------------|---------------|-----------|---------------|-----------|------------|------|-----------|---------|-----------|---------|-------------|----------|----------|----------|--------|
| simple | 4096 | 41 | no-quant | 179.3 | 107.8 | 35 | 230ms | — | — | — | — | 1.40GB | 1.62GB | 0MB | 17MB | Hello! I'm Qwen3.5, the big-oldest-llama-model assistant tha |
