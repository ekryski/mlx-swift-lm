// prefill_bridge_gemma.h — Gemma-family native prefill bridge
//
// Dedicated prefill bridge for Gemma-4 E2B architectures.
// Accepts external weight arrays instead of loading its own.
#ifndef PREFILL_BRIDGE_GEMMA_H
#define PREFILL_BRIDGE_GEMMA_H
...
int gemma_run_array(void* token_arr_ptr, double* out_elapsed_ms, float* out_checksum);

// Get K/V cache handles for a layer
void gemma_get_kv_handles(int layer_idx, void** out_k_ptr, void** out_v_ptr);
